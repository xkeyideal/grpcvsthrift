...
import (
	...
	healthgrpc "grpcvsthrift/grpc/rpcpb"
	healthpb "grpcvsthrift/grpc/rpcpb"
...
func (s *HealthServer) setServingStatusLocked(service string, servingStatus healthpb.HealthCheckResponse_ServingStatus) {
