...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Health Ping()")
  fmt.Fprintln(os.Stderr, "  GetResponse Get(GetRequest req)")
  fmt.Fprintln(os.Stderr, "  PutResponse Put(PutRequest req)")
  fmt.Fprintln(os.Stderr, "  PutResponse MultiPut( reqs)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "MultiPut":
    ...
    containerStruct0 := rpc.NewKVMultiPutArgs()
    err29 := containerStruct0.ReadField1(jsProt28)
    if err29 != nil {
      Usage()
      return
    }
    argvalue0 := containerStruct0.Reqs
    value0 := argvalue0
